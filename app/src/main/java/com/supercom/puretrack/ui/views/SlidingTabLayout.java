...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    protected TextView createDefaultTabView(Context context) {
        ...
        textView.setPadding(padding, padding - 8, padding, padding);
        return textView;
    }
    ...
    private void populateTabStrip() {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            tabTitleView.setTextColor(ContextCompat.getColorStateList(App.getAppContext(), R.color.selector));
            tabTitleView.setTextSize(14);
            if (i == 1) {
                tabTitleView.setBackground(App.getAppContext().getResources().getDrawable(R.drawable.border));
            }
        }
    }
    ...
    private class InternalViewPagerListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageSelected(int position) {
            ...
            for (int i = 0; i < mTabStrip.getChildCount(); i++) {
                ...
                if (i == position) {
                    tv.setBackground(App.getAppContext().getResources().getDrawable(R.drawable.border));
                } else {
                    tv.setBackgroundColor(App.getAppContext().getResources().getColor(R.color.blue_darker));
                }
            }
            if (mViewPagerPageChangeListener != null) {
